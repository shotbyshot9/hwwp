 ...
 * 사용법 대화상자 (도구 → 사용법).
 *
 * WHP 에는 설명 없이는 알기 어려운 동작이 몇 있다 — 저장 버튼이 없는 이유,
...
const SECTIONS: HelpSection[] = [
  {
    ...
    paragraphs: [
      ...
      '제목 줄 오른쪽 「구글 드라이브 연결」을 한 번 누르면, 드라이브에 WHP 폴더가 '
  ...
  },
  {
    title: '드라이브에서 문서 열기',
    paragraphs: [
      '「파일 → 구글 드라이브에서 열기…」를 누르면 WHP 로 저장한 문서가 최근 순으로 나옵니다.',
      ...
      '찾아보기로 연 문서는 원래 있던 자리에서 그대로 갱신됩니다. WHP 폴더에 사본이 '
      + '생기지 않습니다.',
    ],
  },
  {
    title: '집중 작업 모드',
    paragraphs: [
      '「보기 → 집중 작업 모드」 또는 Alt+Shift+F. 나가기는 Esc 입니다.',
      ...
      '집중 모드는 테마와 배율을 따로 가집니다 — 들어가면 어둡게 200% 로 바뀌고 '
      + '나오면 원래 화면으로 돌아옵니다. 「보기 → 집중 모드 설정」에서 바꿉니다.',
    ],
  },
  {
